import { assert, fixture, html, oneEvent, aTimeout, waitUntil } from '@open-wc/testing';
...
describe('Playback', () => {
  ...
  it('should have current time pass 6s after some time', async function() {
    ...
    assert.isAbove(element.video.currentTime, 6, 'Current time should be greater than 6 seconds');
  });
});
